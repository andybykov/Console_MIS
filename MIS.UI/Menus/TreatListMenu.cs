            ...
            while (true)
            {
                ...
                try
                {
                    switch (cmd)
                    {
                        ...
                        case "5":
                            //var newT = PromptTreatmentInput();
                            //_treatMgr.AddTreatmentList(newT);
                            //Console.WriteLine("Лист назначений добавлен");
                            break;
                        ...
                        case "6":
                            ...
                            {
                                //var upd = PromptTreatmentInput();
                                //_treatMgr.UpdateTreatmentList(updId, upd);
